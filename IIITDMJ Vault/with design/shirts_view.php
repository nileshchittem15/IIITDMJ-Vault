		...
		<table id="main" >
		    ...
		    <div id="main-right">
		    	...
		    	<?php
					...
					$query="SELECT * FROM shirts_booked WHERE ROLLNO=$rollno";
					...
					echo '<table border="1" cellspacing="0"><tr><th>DATE</th><th>SHIRT ID</th></tr>';
					while($row=mysql_fetch_assoc($result))
					{
						echo '<tr><td>'.$row['DATE'].'</td><td>'.$row['SHIRT_ID'].'</td></tr>';
					}
					echo mysql_error();
					echo '</table>';
					echo '<a href="shirts.php"><input type="submit" name="back" value="Back" class="freshbutton-blue "></a>';
		    	?>
