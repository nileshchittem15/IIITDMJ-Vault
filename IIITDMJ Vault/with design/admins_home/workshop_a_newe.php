<html>
	...
	<body>
		...
		<table id="main" >
		    ...
		    <center>
		<?php
				echo '<p align="center">All * fields are compulsory</p>';
			session_start();
			...
			echo '<table border="0" cellpadding="10" align="center"><form action="Workshop_a_new_ext.php" method="post">';
			echo '<tr><td>Workshop ID*</td><td><input type="text" name="id"/></td>
				  <tr><td>Workshop Name*</td><td><input type="text" name="name"/></td></tr>
				  <tr><td>BeginDate*</td><td><input type="text" placeholder="yyyy-mm-dd" name="begindate"/></td></tr>
				  <tr><td>LastDate*</td><td><input type="text" placeholder="yyyy-mm-dd" name="lastdate"/></td></tr>
				  <tr><td>Amount*</td><td><input type="text" name="amount"/></td></tr>
				  <tr><td>Description*</td><td><textarea name="description" rows="10" cols="40"></textarea></td></tr>
				  <tr colspan="2"><td align="center" ><input type="submit" value="Proceed" class="freshbutton-blue "></td></form>';
				  echo '<td align="center"><a href="workshop_a.php"><input type="submit" name="back" value="Back" class="freshbutton-blue "></a></td></tr></table>';
		?>
</div>
			</td>
			</tr>
