...
--
-- Host: localhost
-- Generation Time: May 05, 2014 at 07:31 AM
...
(2012005, 1, 30, 1, 31, 25, 'NO'),
(2012005, 4, 26, 4, 30, 100, 'NO'),
...
(2012048, 3, 27, 4, 31, 100, 'NO'),
(2012048, 4, 27, 3, 30, 75, 'NO'),
(2012049, 4, 27, 3, 30, 75, 'NO'),
(2012050, 4, 26, 4, 30, 100, 'NO');
...
(2012018, 566223, 'Fundamentals of Thromodynamics', '2014-04-01', '2014-04-16', '2014-04-23', 7),
(2012040, 124576, 'Swami Vivekananda ', '2014-03-05', '2014-03-20', '2014-05-01', 42),
(2012043, 110000, 'Is The Soul Immortal by Swami Vivekananda', '2013-07-01', '2013-07-16', '2014-04-30', 288),
(2012043, 112203, 'Multimedia Data Hiding ', '2014-03-26', '2014-04-10', '2014-04-11', 1),
(2012043, 124545, 'Network analyisis', '2014-04-03', '2014-04-18', '2014-04-19', 1);
...
(2012001, 'Aaditya Sujeria', '1994-02-11', 'CSE', 'BTECH', 2012, 4219, '2012001', '2012001', ' Aaditya rao'),
...
(2012005, 'Abbadasari Prateesh', '1993-08-15', 'ECE', 'BTECH', 2012, 3700, '2012005', '2012005', ' Abbadasari rajesh'),
...
(2012010, 'Abhishek Shrivastava', '1994-01-13', 'CSE', 'BTECH', 2012, 5000, '2012010', '2012010', 'rajesh Shrivastava'),
(2012011, 'Abhishek Singh ', '1994-12-15', 'ECE', 'BTECH', 2012, 5000, '2012011', '2012011', 'Arjith Singh '),
...
(2012018, 'Alok Sahoo', '2014-01-30', 'ME', 'BTECH', 2012, 5000, '2012018', '2012018', ' yaswanth  Sahoo'),
(2012019, 'Aman Khare', '1993-05-20', 'ECE', 'BTECH', 2012, 5000, '2012019', '2012019', 'rahul Khare'),
(2012020, 'Amit Giri ', '1994-06-04', 'CSE', 'BTECH', 2012, 5000, '2012020', '2012020', 'karan Giri '),
...
(2012043, 'Arpit Gupta ', '1994-05-20', 'ME', 'BTECH', 2012, 5000, '2012043', '2012043', 'dheraj Gupta '),
...
(2012048, ' Arushi Dev', '1993-05-14', 'ME', 'BTECH', 2012, 5000, '2012048', '2012048', 'rahul Dev'),
(2012049, 'srikanth singh', '1992-04-18', 'ECE', 'BTECH', 2012, 5000, '2012049', '2012049', 'prudhvi singh'),
(2012050, 'Ashutosh Ranjan Dwivedi', '1994-01-28', 'ECE', 'BTECH', 2012, 5000, '2012050', '2012050', 'Abishekh Ranjan Dwivedi');
...
(7, 'Cadence Workshop', '2014-03-01', '2014-05-01', 1500, 'workshop and hands-on-training on Cadence IC (CIC) design in collaboration with Cadence (India).'),
...
(1100, 'A workshop on MATLAB for Engineering computations', '2014-03-01', '2014-05-01', 11000, 'MATLAB is excellent tool for visualization and manipulation of engineering data as well as performing various engineering computations.'),
(1212, 'Photography Workshops', '2014-04-01', '2014-05-01', 1500, 'To enhance your photographic skills join with us.'),
(1598, 'Embedded systems', '2014-02-01', '2014-05-01', 12000, 'An embedded system is a computer system with a dedicated function within a larger mechanical or electrical system.');
...
--
ALTER TABLE `book`
  ADD CONSTRAINT `book_ibfk_1` FOREIGN KEY (`rollno`, `bid`) REFERENCES `book_info` (`rollno`, `bid`) ON DELETE CASCADE;
