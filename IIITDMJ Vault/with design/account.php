		    ...
		    <div id="main-right-account" >
				<table id="table-account" >
					...
					<tr>
						...
						<td class="ans">
							...
							<?php
								...
								$query1="SELECT BALANCE FROM students WHERE ROLLNO=".$_SESSION['ROLLNO']."";
					...
					<tr >
						...
						<?php
							$query2="SELECT * FROM trans WHERE ROLLNO=".$_SESSION['ROLLNO']." ORDER BY id DESC LIMIT 0,5";
					...
					<tr>
						<td align="center">
							<a href="moreinfo.php" class="ans">More Info</a>
						</td>
						<td class="ans">
